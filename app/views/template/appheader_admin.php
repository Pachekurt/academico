							...
							<div class="container-fluid">
								<div class="d-flex">
									<a class="header-brand" href="<?= BASE_URL?>home">
										<img src="<?php echo recursos() ?>/images/brand/logo.png" class="header-brand-img desktop-lgo" alt="Zendashlogo">
										<img src="<?php echo recursos() ?>/images/brand/logo2.png" class="header-brand-img dark-logo" alt="Zendashlogo">
										<img src="<?php echo recursos() ?>/images/brand/favicon.png" class="header-brand-img mobile-logo" alt="Zendashlogo">
										<img src="<?php echo recursos() ?>/images/brand/favicon1.png" class="header-brand-img darkmobile-logo" alt="Zendashlogo">
									</a>
									...
									<div class="d-flex order-lg-2 ml-auto">
										...
										<div class="dropdown profile-dropdown">
											<a href="#" class="nav-link pr-0 pl-2 leading-none" data-toggle="dropdown">
												<span>
													<img src="<?php echo recursos() ?>/images/users/14.jpg" alt="img" class="avatar avatar-md brround">
												</span>
											</a>
											<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow animated p-0">
												<div class="text-center border-bottom pb-4 pt-4">
													<a href="#" class="text-center user pb-0 font-weight-bold">Alvaro Pacheco</a>
													<p class="text-center user-semi-title mb-0">Director sistemas</p>
												</div>
												<a class="dropdown-item border-bottom" href="#">
													<i class="dropdown-icon mdi mdi-account-outline"></i> Mi cuenta
												</a>
												<a class="dropdown-item border-bottom" href="#">
													<i class="dropdown-icon zmdi zmdi-edit"></i> Editar mi cuenta
												</a> 
												 
												 
												<a class="dropdown-item border-bottom" href="#">
													<i class="dropdown-icon mdi  mdi-logout-variant"></i> Cerrar sesion
												</a>
											</div>
										</div>
									</div>
